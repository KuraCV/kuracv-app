        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="w-full">
            {googleClientId ? (
              <GoogleLogin
                ...
                render={(renderProps) => (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-surface border border-outline-variant hover:bg-surface-container-low transition-all duration-200 py-3 px-4 rounded-xl font-medium text-label-md text-on-surface mb-5 active:scale-[0.98] cursor-pointer disabled:opacity-50"
                  >
                    {/* SVG Google Icon */}
              ...
              <button
                disabled
                className="w-full flex items-center justify-center gap-3 bg-surface border border-outline-variant opacity-50 py-3 px-4 rounded-xl font-medium text-label-md text-on-surface mb-5 cursor-not-allowed"
              >
                <svg aria-hidden="true" className="w-5 h-5" viewBox="0 0 24 24">
                  <path
                    d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
